...
const ImageList = [
  {
    ...
    description:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet quasi vel voluptas, molestiae tenetur odio officiis quo laudantium accusamus animi perferendis nulla aperiam numquam iusto officia. Quaerat reprehenderit ab perspiciatis.",
  },
  {
    id: 2,
    img: Image2,
        ...
        <Slider {...settings}>
          {ImageList.map((data) => (
            <div key={data.id}>
              ...
              sm:text-left order-2 sm:order-1 relative z-10 pl-4"
                >
                  <h1
                    data-aos="zoom-out"
